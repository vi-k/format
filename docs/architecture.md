...
- `docs/handoff.md` — единственная точка восстановления текущей сессии.
...
- Спеки, планы, отчёты и другие замороженные записи лежат плоско в
  `docs/records/YYYY-MM-DD[N]-name.md` и имеют строку `Статус:` под заголовком.
