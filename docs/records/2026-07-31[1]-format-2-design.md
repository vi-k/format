...
> изменения вошли в 3.0.0.
> **Что это:** дизайн Format 2.0 — публичный API, конфигурация `Format` и
> расширения второй версии.
> **Связанные записи:** `2026-07-31[2]-format-2-plan.md`,
> `2026-08-01[3]-format-3-python-compatibility-design.md`.
