...
- [ ] **Step 1: Добавить integer-регрессию**
...
- [ ] **Step 2: Добавить double-матрицу**
...
- [ ] **Step 3: Запустить целевые тесты**
...
- [ ] **Step 4: Закоммитить тестовую матрицу**
...
- [ ] **Step 1: Написать падающий тест сценария**
...
- [ ] **Step 5: Зафиксировать benchmark-контракт**
...
- [ ] **Step 1: Зафиксировать performance RED**
...
- [ ] **Step 2: Реализовать минимальный fast path**
...
- [ ] **Step 4: Запустить пользовательский benchmark**
