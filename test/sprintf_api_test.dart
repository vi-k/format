...
/// dangling `%`, a missing argument, a value of the wrong type and a
/// [Object.toString] that throws — each with the offset and the argument index
/// filled in, since a printf template gives a reader nothing else to locate the
/// fault by.
library;
